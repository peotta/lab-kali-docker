...
> Todo comando e técnica deste laboratório deve ser usado **exclusivamente** contra os alvos acima, dentro da rede isolada `172.20.0.0/24`. Ver Seção 2 do [roteiro completo](https://github.com/peotta/lab-kali-docker/blob/main/guia-aluno-roteiro.md) para o aviso legal.

## Próximos passos

- **Alunos:** siga o [`guia-aluno-roteiro.md`](https://github.com/peotta/lab-kali-docker/blob/main/guia-aluno-roteiro.md) do início ao fim
...
Material didático para fins educacionais, em ambiente isolado. Uso fora desse contexto não é autorizado nem endossado. Produzido pelo professor Laerte Peotta de Melo, com auxílio da IA Claude (Anthropic).
